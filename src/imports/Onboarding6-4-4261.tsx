import svgPaths from "./svg-fwp0nr0z83";
  ...
  return (
    <svg className="block size-full" fill="none" preserveAspectRatio="none" viewBox="0 0 20 20">
      <g id="notification-bing">
        <path d={svgPaths.p2f953770} id="Vector" stroke="var(--stroke-0, white)" strokeLinecap="round" strokeMiterlimit="10" strokeWidth="1.5" />
        <path d={svgPaths.p2a7ea80} id="Vector_2" stroke="var(--stroke-0, white)" strokeMiterlimit="10" strokeWidth="1.5" />
...
function Frame2131331356() {
  return (
    <div className="bg-[#4839ff] box-border content-stretch flex items-center justify-between overflow-clip px-[25px] py-[10px] relative rounded-[20px] shrink-0 w-[361px]">
      <Frame2131331386 />
...
function Frame2131331355() {
  return (
    <div className="content-stretch flex flex-col gap-[10px] items-center relative shrink-0">
      <Frame2131331324 />
      <Frame2131331356 />
      <p className="font-['Nunito:Regular',_sans-serif] font-normal leading-[normal] min-w-full relative shrink-0 text-[14px] text-center text-white w-[min-content]">Tienes una hora de descanso disponible</p>
    ...
    <div className="relative shrink-0 w-full">
      <div className="flex flex-row items-center justify-center size-full">
        <div className="box-border content-stretch flex gap-[10px] items-center justify-center px-[15px] py-0 relative w-full">
          <div className="basis-0 font-['Nunito:Bold',_sans-serif] font-bold grow leading-[normal] min-h-px min-w-px relative shrink-0 text-[#2a2a2a] text-[14px]">
            <p className="mb-0">Siguientes Rutas:</p>
            <p className="font-['Nunito:Regular',_sans-serif] font-normal">Tienes 8 rutas faltantes para el resto del día.</p>
          </div>
        </div>
      </div>
    </div>
...
function Frame2131331261() {
  return (
    <div className="bg-white box-border content-stretch flex flex-col gap-[20px] h-[716px] items-center overflow-clip pb-0 pt-[15px] px-0 relative rounded-tl-[40px] rounded-tr-[40px] shrink-0 w-full">
...
export default function Onboarding6() {
  return (
    <div className="bg-gradient-to-b box-border content-stretch flex flex-col from-[#331fff] items-center justify-between overflow-clip pb-0 pt-[40px] px-0 relative rounded-[60px] size-full to-[#3b3aff] via-50% via-[#4150fd]" data-name="Onboarding 6">
      <Frame2131331355 />
      <Frame2131331261 />
